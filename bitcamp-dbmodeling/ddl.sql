...
CREATE TABLE P1_APPL (
	...
	MMO  INTEGER NOT NULL COMMENT '학생번호', -- 학생번호
...
CREATE TABLE P1_STUD (
	MMO      INTEGER      NOT NULL COMMENT '학생번호', -- 학생번호
	ADRNO    INTEGER      NULL     COMMENT '주소 번호', -- 주소 번호
	DET_ADDR VARCHAR(255) NULL     COMMENT '상세주소', -- 상세주소
	WORK     CHAR(1)      NOT NULL COMMENT '재직여부', -- 재직여부
	LST_SCH  VARCHAR(50)  NOT NULL COMMENT '최종학력', -- 최종학력
...
-- 매니저
CREATE TABLE P1_MGR (
	MGMO INTEGER     NOT NULL COMMENT '매니저번호', -- 매니저번호
...
CREATE TABLE P1_OPEN_CORS (
	...
	MGMO   INTEGER     NULL     COMMENT '매니저번호' -- 매니저번호
)
COMMENT '개설교육과정';
...
-- 개설교육과정 유니크 인덱스
CREATE UNIQUE INDEX UIX_P1_OPEN_CORS
	ON P1_OPEN_CORS ( -- 개설교육과정
		CNO ASC -- 교육기수
	);
...
CREATE TABLE P1_CLR_PHOT (
	CPNO  INTEGER      NOT NULL COMMENT '강의실 사진 번호', -- 강의실 사진 번호
	CLRNO INTEGER      NOT NULL COMMENT '강의실번호', -- 강의실번호
...
ALTER TABLE P1_CLR_PHOT
	ADD CONSTRAINT PK_P1_CLR_PHOT -- 강의실 사진 기본키
		PRIMARY KEY (
			CPNO -- 강의실 사진 번호
		);

ALTER TABLE P1_CLR_PHOT
	MODIFY COLUMN CPNO INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의실 사진 번호';

-- 주소
CREATE TABLE P1_ADDR (
	ADR      INTEGER      NOT NULL COMMENT '주소 번호', -- 주소 번호
...
ALTER TABLE P1_ADDR
	MODIFY COLUMN ADR INTEGER NOT NULL AUTO_INCREMENT COMMENT '주소 번호';
...
CREATE TABLE P1_MEMB (
	MMO   INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
...
-- P1_MEMB
ALTER TABLE P1_MEMB
	ADD CONSTRAINT PK_P1_MEMB -- P1_MEMB 기본키
		PRIMARY KEY (
			MMO -- 회원번호
		);
...
ALTER TABLE P1_MEMB
	MODIFY COLUMN MMO INTEGER NOT NULL AUTO_INCREMENT COMMENT '회원번호';
...
-- 학생
ALTER TABLE P1_STUD
	ADD CONSTRAINT FK_P1_MEMB_TO_P1_STUD -- P1_MEMB -> 학생
		FOREIGN KEY (
			MMO -- 학생번호
		)
		REFERENCES P1_MEMB ( -- P1_MEMB
			MMO -- 회원번호
		);

-- 강사
ALTER TABLE P1_TCH
	ADD CONSTRAINT FK_P1_MEMB_TO_P1_TCH -- P1_MEMB -> 강사
		FOREIGN KEY (
			MNO -- 강사번호
		)
		REFERENCES P1_MEMB ( -- P1_MEMB
...
-- 매니저
ALTER TABLE P1_MGR
	ADD CONSTRAINT FK_P1_MEMB_TO_P1_MGR -- P1_MEMB -> 매니저
		FOREIGN KEY (
			MGMO -- 매니저번호
		)
		REFERENCES P1_MEMB ( -- P1_MEMB
...
-- 강의실 사진
ALTER TABLE P1_CLR_PHOT
	ADD CONSTRAINT FK_P1_CLS_ROOM_TO_P1_CLR_PHOT -- 강의실 -> 강의실 사진
		FOREIGN KEY (
			CLRNO -- 강의실번호
		)
		REFERENCES P1_CLS_ROOM ( -- 강의실
