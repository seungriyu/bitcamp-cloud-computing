...
-- 명함
DROP TABLE IF EXISTS P2_BIIZCARD RESTRICT;
...
-- 명함
ALTER TABLE P2_BIIZCARD
    ADD CONSTRAINT PK_P2_BIIZCARD -- 명함 기본키
        PRIMARY KEY (
            BCNO -- 명함번호
        );

-- 명함 인덱스
CREATE INDEX IX_P2_BIIZCARD
    ON P2_BIIZCARD( -- 명함
        NAME ASC -- 이름
    );
...
-- 명함
ALTER TABLE P2_BIIZCARD
    ADD CONSTRAINT FK_P2_MEMB_TO_P2_BIIZCARD -- 회원 -> 명함
        FOREIGN KEY (
            MNO -- 회원번호
        )
