...
//=> 애노테이션으로 설정하기
@MultipartConfig(
            fileSizeThreshold=1024*1024, //1MB 를 넘어가는 파일일 경우 메모리에 저장하지 말고 임시 폴더에 저장한다. 
            maxFileSize=1024*1024*2, // 한 개 파일의 최대 크기를 제한한다.
            maxRequestSize=1024*1024*2*10 //요청 데이터 전체 크기를 제한한다.
                )
